...
cors_origins = os.getenv("CORS_ORIGINS", "http://localhost:3000,http://localhost:8080,https://barcode-gene-frontend.vercel.app,https://barcode-gene-frontend-hmnff9rd3-ericytexs-projects.vercel.app,https://barcode-api.trycloudflare.com").split(",")
app.add_middleware(
    CORSMiddleware,
